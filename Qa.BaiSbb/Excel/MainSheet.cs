    ...
    public class MainSheet
    {
        ...
        private static void PrintTotal(IList<CompareReport> reports, ExcelCursor cursor)
        {
            ...
            cursor
                ...
                .Print("Total Records")
                .Right()
                .Print(reports.First().RowsCount.Current, DType.Int)
                .Down()
            ...
            foreach (var report in reports.Skip(1))
            {
                cursor.Row(initRow)
                    ...
                    .Down()
                    .Print(report.RowsCount.Current, DType.Int)
                    .Right()
                    .Print((double)report.RowsCount.Previous/report.RowsCount.Current, DType.Percent)
                    .Down()
